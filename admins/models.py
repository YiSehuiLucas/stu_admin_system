...
class Admin(models.Model):
    admin_id = models.OneToOneField(User, on_delete=models.CASCADE, max_length=100,db_column='admin_id',primary_key=True, verbose_name='管理员ID')
...
class Teacher(models.Model):
    tch_id = models.OneToOneField(User,on_delete=models.CASCADE,max_length=100, db_column='tch_id',primary_key=True, verbose_name='教师ID')
...
class TeacherDepart(models.Model):
    tch_id = models.ForeignKey(Teacher, on_delete=models.CASCADE, max_length=100, db_column='tch_id', verbose_name='教师ID')
    depart_id = models.ForeignKey(Depart, on_delete=models.CASCADE,  max_length=100, db_column='depart_id', verbose_name= '院系ID')
    def __str__(self):
...
class Student(models.Model):
    stu_id = models.OneToOneField(User,on_delete=models.CASCADE,max_length=100,db_column='stu_id',primary_key=True, verbose_name='学生ID')
    stu_name = models.CharField(max_length=100, verbose_name='学生姓名')
    stu_phnum = models.CharField(max_length=100, verbose_name='联系电话')
    stu_semester = models.ForeignKey(Semesters,on_delete=models.CASCADE,max_length=100, db_column='stu_semester',verbose_name='年级')
    def __str__(self):
...
class StudentClass(models.Model):
    stu_id = models.ForeignKey(Student,on_delete=models.CASCADE,max_length=100, db_column='stu_id', verbose_name='学生ID')
    class_id = models.ForeignKey(Class,on_delete=models.CASCADE,max_length=100, db_column='class_id', verbose_name='班级ID')
    def __str__(self):
...
class StudentMajor(models.Model):
    stu_id = models.ForeignKey(Student,on_delete=models.CASCADE, max_length=100, db_column='stu_id', verbose_name='学生ID')
    major_id = models.ForeignKey(Major, on_delete=models.CASCADE, max_length=100, db_column='major_id', verbose_name='专业ID')
    def __str__(self):
