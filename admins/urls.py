...
urlpatterns = [
    ...
    path('teachers/<str:user_id>/', views.teacher_list, name='teacher_list'),
    path('teachers/create/<str:user_id>/', views.teacher_create, name='teacher_create'),
    path('teachers/<str:tch_id>/update/', views.teacher_edit, name='teacher_edit'),
    path('teachers/<str:tch_id>/delete/<str:user_id>/', views.teacher_delete, name='teacher_delete'),
    path('teachers/import/<str:user_id>/', views.teacher_import, name='teacher_import'),
