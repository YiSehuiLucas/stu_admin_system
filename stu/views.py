...
def stu_select(request):
    ...
    if request.method == 'GET':
        return render(request, "stu_select.html",
                      {"str": str, "semesters": first_semesters, "courses": courses, "stu_id": stu_id,
...
def stu_grade(request):
    ...
    if request.method == 'POST':
        ...
        if total == None:
            total = "0"
        return render(request, "stu_grade.html",
                      {"total": total, "grades": gradelist, "stu_id": stu_id, "semesters": first_semesters, "str": str})
    if request.method == 'GET':
        return render(request, "stu_grade.html",
                      {"total": total, "grades": gradelist, "stu_id": stu_id, "semesters": first_semesters, "str": str})
...
def stu_course(request):
    ...
    if request.method == 'GET':
        ...
        return render(request, "stu_course.html",
                      {"stu_id": stu_id, "courses": courses_stu, "semesters": first_semesters, "str": str})
    if request.method == 'POST':
        str = request.POST.get('option')
        str_test = request.POST.get('optionnull')
        print(str_test)
...
def stu_free(request):
    ...
    if request.method == 'GET':
        ...
        cursor.close()
        return render(request, "stu_free.html",
                      {"stu_id": stu_id, "status": status, "str": str, "APlist": APlist, "courseslist": courseslist})
    if request.method == 'POST':
        str = request.POST.get('option')
        str_test = request.POST.get('optionnull')
